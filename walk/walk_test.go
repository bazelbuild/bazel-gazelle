...
func TestUpdateDirs(t *testing.T) {
	dir, cleanup := testtools.CreateFiles(t, []testtools.FileSpec{
		...
		{Path: "update/ignore_subdir/"},
		{
			Path:    "update/ignore_subdir/BUILD.bazel",
			Content: "# gazelle:ignore_subdir ignored_dir",
		},
		{Path: "update/ignore_subdir/do_not_ignore_me/"},
		{Path: "update/ignore_subdir/ignored_dir/"},
		{Path: "update/ignore_subdir/ignored_dir/sub/"},
		{Path: "update/ignore_subdir/ignored_dir/sub/BUILD.bazel"},
		{
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			want: []visitSpec{
				...
				{"update/ignore", false},
				{"update/ignore_subdir/do_not_ignore_me", true},
				{"update/ignore_subdir/ignored_dir/sub", false},
				{"update/ignore_subdir/ignored_dir", false},
				{"update/ignore_subdir", true},
				{"update/sub/sub", true},
				{"update/sub", true},
				{"update", true},
				{"", false},
			...
			want: []visitSpec{
				...
				{"update/ignore/sub", true},
				{"update/ignore", false},
				{"update/ignore_subdir/do_not_ignore_me", false},
				{"update/ignore_subdir/ignored_dir/sub", false},
				{"update/ignore_subdir/ignored_dir", false},
				{"update/ignore_subdir", false},
			...
			desc: "update_subdirs",
			rels: []string{"update/ignore", "update/sub", "update/ignore_subdir"},
