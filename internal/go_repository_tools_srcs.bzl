...
GO_REPOSITORY_TOOLS_SRCS = [
	...
	Label("//rule:types.go"),
	Label("//rule:value.go"),
	Label("//runner:BUILD.bazel"),
	Label("//runner:diff.go"),
	Label("//runner:fix-update.go"),
	Label("//runner:fix.go"),
	Label("//runner:gazelle.go"),
	Label("//runner:langs.go"),
	Label("//runner:metaresolver.go"),
	Label("//runner:print.go"),
	Label("//runner:update-repos.go"),
