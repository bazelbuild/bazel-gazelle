...
.. code:: bzl
    ...
    http_archive(
        ...
        urls = [
            "https://mirror.bazel.build/github.com/bazelbuild/bazel-gazelle/releases/download/v0.30.1/bazel-gazelle-v0.30.1.tar.gz",
            "https://github.com/bazelbuild/bazel-gazelle/releases/download/v0.30.1/bazel-gazelle-v0.30.1.tar.gz",
        ],
    )
