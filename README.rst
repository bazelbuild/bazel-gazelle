...
| :direc:`# gazelle:repository_macro +macroFile%defName`             | n/a                                    |
+--------------------------------------------------------------------+----------------------------------------+
| A repository macro file can be prepended with a "+" if this macro also loads other repository macros. This  |
| tells Gazelle to check for repositories in these other loaded repository macros                             |
+--------------------------------------------------------------------+----------------------------------------+
